...
void PedirDatos(Passenger listaPassengers[], int tam)
{
	...
	PedirCadena(flycode,"Ingrese el código de vuelo.\n","Error, ingrese el código de vuelo\n",0);
...
int RemovePassenger(Passenger listaPassengers[], int sizePassengers) //FUNCIÓN OBLIGATORIA
{
	int index;
	int id;
	int retornoEstado=-1;
